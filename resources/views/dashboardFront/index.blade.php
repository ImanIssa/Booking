...
<html lang="en">
  ...
  <body class="app sidebar-mini">
    <!-- Navbar-->
    <header class="app-header"><a class="app-header__logo" href="dashboardFront/index.blade.php">Dashboard</a>
      ...
      <ul class="app-nav">
        ...
        <li class="dropdown"><a class="app-nav__item" href="#" data-toggle="dropdown" aria-label="Open Profile Menu"><i class="fa fa-user fa-lg"></i></a>
          <ul class="dropdown-menu settings-menu dropdown-menu-right">
            <li><a class="dropdown-item" href="dashboardFront/page-user.blade.php"><i class="fa fa-cog fa-lg"></i> Settings</a></li>
            <li><a class="dropdown-item" href="dashboardFront/page-user.blade.php"><i class="fa fa-user fa-lg"></i> Profile</a></li>
            <li><a class="dropdown-item" href="dashboardFront/page-login.blade.php"><i class="fa fa-sign-out fa-lg"></i> Logout</a></li>
          </ul>
        </li>
      </ul>
    </header>
    ...
    <span class="app-menu__label">Profile</span><i class="treeview-indicator fa fa-angle-right"></i></a>
          <ul class="treeview-menu">
            <li><a class="treeview-item" href="bootstrap-components.blade.php"><i class="icon fa fa-circle-o"></i>Profile</a></li>
            ...
            <li><a class="treeview-item" href="dashboardFront/widgets.blade.php"><i class="icon fa fa-circle-o"></i> Widgets</a></li>
          </ul>
        </li>
  ...
  <span class="app-menu__label">Doctors</span><i class="treeview-indicator fa fa-angle-right"></i></a>
        ...
        <li class="treeview"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-check-circle" aria-hidden="true"></i></i><span class="app-menu__label">Schedule</span><i class="treeview-indicator fa fa-angle-right"></i></a>
          <ul class="treeview-menu">
            <li><a class="treeview-item" href="dashboardFront/bootstrap-components.blade.php"><i class="icon fa fa-circle-o"></i>Profile</a></li>
            <li><a class="treeview-item" href="https://fontawesome.com/v4.7.0/icons/" target="_blank" rel="noopener"><i class="icon fa fa-circle-o"></i> Font Icons</a></li>
            <li><a class="treeview-item" href="dashboardFront/ui-cards.blade.php"><i class="icon fa fa-circle-o"></i> Cards</a></li>
        ...
        <li class="treeview"><a class="app-menu__item" href="#" data-toggle="treeview"><i class=" fa fa-h-square" aria-hidden="true"></i></i><span class="app-menu__label">ealth Center</span><i class="treeview-indicator fa fa-angle-right"></i></a>
          <ul class="treeview-menu">
            <li><a class="treeview-item" href="dashboardFront/bootstrap-components.blade.php"><i class="icon fa fa-circle-o"></i>Profile</a></li>
            <li><a class="treeview-item" href="https://fontawesome.com/v4.7.0/icons/" target="_blank" rel="noopener"><i class="icon fa fa-circle-o"></i> Font Icons</a></li>
            <li><a class="treeview-item" href="dashboardFront/ui-cards.blade.php"><i class="icon fa fa-circle-o"></i> Cards</a></li>
